...
{:cljdoc.doc/tree [["Readme" {:file "README.md"}]
                   ...
                   ["#my-lib on Slack" {:url "https://clojurians.slack.com/my-lib"}]]}
----
...
IMPORTANT: The resulting URLs for those articles will be based on the title provided in the `cljdoc.edn` file and _not_ on the filename. External links will open in a new tab.
